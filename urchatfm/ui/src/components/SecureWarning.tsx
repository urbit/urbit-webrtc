...
export const SecureWarning = () => {
  ...
  return (
    <Dialog defaultOpen>
      ...
      >
        <p>urChatFM is built on top of WebRTC which requires HTTPS to function. You may need to provision a certificate for your Urbit or contact your host, or you just need to visit the HTTPS version of your site.</p>
